...
#
    ...
    y_rep = UI_Y1 + 30
    label = "Question:"
    cv2.putText(frame, label, (x_rep+5,y_rep), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255,255,255), 2)
    y_rep += offset
    label = '   ' + randomAnn['question']
    cv2.putText(frame, label, (x_rep+5,y_rep), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255,255,255), 1)
    y_rep += offset
    label = "Answers:"
    cv2.putText(frame, label, (x_rep+5,y_rep), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255,255,255), 2)
    y_rep += offset
    for x in randomAnn['answers']:
        label = '   ' + x['answer']
        cv2.putText(frame, label, (x_rep+5,y_rep), cv2.FONT_HERSHEY_SIMPLEX, font_size, (255,255,255), 1)
        y_rep += offset
